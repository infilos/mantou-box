...
import com.infilos.mantou.views.forms.CountryModel;

import java.util.Locale;
import java.util.ResourceBundle;

/**
 * This class is used to create the form and holds all the necessary data. This class acts as a singleton where the current instance is available using {@code getInstance}.
 *
 * @author Sacha Schmid
...
public final class DemoModel {
    ...
    /**
     * The default locale is English, thus the {@code ResourceBundleService} is initialised with it.
     */
